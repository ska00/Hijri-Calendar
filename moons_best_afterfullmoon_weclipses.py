...
The data would be more easily accessed if it can be put into an SQL database
...
the year of the second January to 3870. Keep this in mind when using the data_scraper_with_eclipses.py
...
def get_filename(start_year, end_year, contains_eclipse = False):
	...
	_FILE = FILE_W_ECLIPSES if contains_eclipse else FILES
